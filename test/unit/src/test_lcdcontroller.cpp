...
TEST(LcdController, create_new_weather_page_struct_independant)
{
    ...
    auto reading_1 = ws1->set_reading("1.1", 34.4, nullptr, &conf);
    WeatherSensor* ws2 = new WeatherSensor("2.0", "weather2");
    auto reading_2 = ws2->set_reading("2.1", 25.46, nullptr, &conf);

    I2cControl *i2c = new I2cControl(3);
    LcdDriver lcd(39, i2c);
...
TEST(LcdController, draw_basic_page_to_lcd)
{
    ...
    auto reading = ws1->set_reading("1.1", 34.4, nullptr, &conf);
...
TEST(LcdController, update_values_only_on_existing_page)
{
    ...
    auto reading = ws1->set_reading("1.0", 36.0, nullptr, &conf);
    auto reading_hum = ws1->set_reading("1.1", 79.0, nullptr, &conf);
    ...
    ws1->set_reading("1.0", 24.0, nullptr, &conf);
    ws1->set_reading("1.1", 56.0, nullptr, &conf);
